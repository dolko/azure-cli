...
# def setup_devops_remote(cmd, organization_name, project_name, repository_name, remote_name):
#     azure_devops_build_provider = AzureDevopsBuildProvider(cmd.cli_ctx)
#     return azure_devops_build_provider.setup_remote(organization_name, project_name, repository_name, remote_name)
